            ...
            <form className="flex pl-2 w-full">
                <div className="flex flex-grow rounded-sm ">
                    <div className="flex flex-grow items-center">
                        ...
                        <input value={searchText} onChange={handleInput} required type="search" name='searchText' id='searchTextDesktop' className='flex border shadow-lg focus:ring-1 text-lg w-full pl-14 py-3 pr-2 p rounded-lg overflow-hidden focus-within:shadow-none outline-none sm:items-center' placeholder='Seacrh Here for other crypto ' />
                    </div>
                </div>
            </form>
            {searchText.length > 0 ? (
                <ul  className='absolute top-14 -right-2 w-full h-96 mr-2 bg-white rounded overflow-x-hidden py-2 overflow-scroll scrollbar-thin backdrop-blur-md z-10'>
                    {searchData ? (
                        ...
                        <div className="w-full h-full mt-8 flex justify-center items-center">
                            ...
                            <span className="ml-2 font-semibold">Finding Your Crypto</span>
                        </div>
                    )}
