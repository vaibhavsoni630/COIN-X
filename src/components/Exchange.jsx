...
export default function Exchange() {
  ...
  const change = () => {
    const unit = coin?.[value2]?.unit;
    setUnits(unit ?? ''); 
    const result = ((value2 ?? 1) / value1) * text1; 
    setText2(result);
  };
  return (
      ...
      <div className="flex flex-row mt-8">
        <div className="pr-4 items-center">
          <div className="flex my-1 content-center items-center py-1 px-2 lg:ml-3">
            ...
            <p className="text-red-700 font-bold mr-3 ">SELL</p>
            <select
          ...
          <div className="flex my-2 content-center items-center px-2 py-2 mt lg:ml-3">
          
            {/* Buy Button */}
          
            <p className="text-green-800 font-bold mr-3">BUY</p>
            <select
              className="w-[130px] h-[2rem] bg-gray-100 rounded-lg font-semibold p-1 bg-opacity-60 backdrop-blur-md focus:ring-2 px-5 inline-flex cursor-pointer"
        ...
        <div className="-mt-6 lg:pl-10 mr-3">
          <div>
            ...
            <p className="mt-4 text-green-500 focus:border-gray-500 rounded border border-gray-400 px-3 py-1   text-transform:capitalize">
