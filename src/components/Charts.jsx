...
export default function Charts() {
    ...
    return (
        ...
        <div className="container-fluid w-full h-120 border  border-gray-100 bg-opacity-10 backdrop-blur-md my-5 rounded-lg px-4 pt-3 lg:mt-3">
            ...
            <div className="flex lg:gap-12 absolute items-center lg:ml-48 md:ml-16 sm:ml-28 ml-16 gap-2 lg:left-34 left-4 md:mt-3 lg:mt-8 sm:mt-3 mt-3">
                {/* Created Buttons For the Sorting of Graph */}
                <button value={2} className={`px-3 py-1.5 ${days === 1 ? "border-black" : ""} rounded-md text-xs bg-gray-200 backdrop-blur-md font-bold lg:mt-2 hover:bg-orange-600 active:bg-orange-700 focus:outline-none focus:ring focus:ring-orange-300`} onClick={oneDay}>
                    1D
                </button>
                <button value={7} className={`px-3 py-1.5 ${days === 7 ? "border-black" : ""} rounded-md text-xs bg-gray-200 backdrop-blur-md font-bold lg:mt-2 hover:bg-orange-600 active:bg-orange-700 focus:outline-none focus:ring focus:ring-orange-300`} onClick={oneWeek}>
                    1W
                </button>
                <button value={30} className={`px-3 py-1.5 ${days === 30 ? "border-black" : ""} rounded-md text-xs bg-gray-200 backdrop-blur-md font-bold lg:mt-2 hover:bg-orange-600 active:bg-orange-700 focus:outline-none focus:ring focus:ring-orange-300`} onClick={oneMonth}>
                    1M
                </button>
                <button value={180} className={`px-3 py-1.5 ${days === 180 ? "border-black" : ""} rounded-md text-xs bg-gray-200 backdrop-blur-md font-bold lg:mt-2 hover:bg-orange-600 active:bg-orange-700 focus:outline-none focus:ring focus:ring-orange-300`} onClick={sixMonth}>
                    6M
                </button>
                <button value={365} className={`px-3 py-1.5 ${days === 365 ? "border-black" : ""} rounded-md text-xs bg-gray-200 backdrop-blur-md font-bold lg:mt-2 hover:bg-orange-600 active:bg-orange-700 focus:outline-none focus:ring focus:ring-orange-300`} onClick={oneYear}>
                    1Y
                </button>
                <div className="flex absolute items-center rounded-md bg-gray-100 backdrop-blur-md p-2 w-24  lg:left-[35rem] lg:mt-4 md:left-[25rem] md:mt-4 sm:right-[9rem] mt-20 ml-2">
                    ...
                    <div className="rounded-md bg-gray-100 backdrop-blur-md p-2 absolute lg:left-[6rem] md:left-[6rem] left-[6rem] w-28 ml-5">
                        <select className='bg-transparent outline-none w-full sm:justify-center' onChange={(x) => setChartType(x.target.value)}>
                            ...
                            <option value={`BarChartH`} className="text-gray-800  " >Bar Chart Horizontal </option>
                            <option value={`LineChart`} className="text-gray-800  ">Line Chart</option>
                            <option value={`BarChartV`} className="text-gray-800  ">Bar Chart Vertical</option>
                        </select>
                    </div>
                </div>
            </div>
